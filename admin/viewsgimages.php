...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Gallery Application</h1>
                </div>
			...
			<?php
				include"connect.php";
            $sqlq = "select name from tbl_album where status='process' and albumid='$asid' ";
			$rs_result1 = mysqli_query ($con,$sqlq);
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4>Gallery Details Of  <?php echo $row["name"]; ?> Album </h4> 
                        </div>
<?php
}
?> 
...
<tbody>
                                        <tr>
                                            ...
                                            <td><img src="gcatch/<?php echo $row["gimages"]; ?>"  width="100px"/></td>
